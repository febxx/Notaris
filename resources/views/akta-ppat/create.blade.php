            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nilai_pengalihan">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="njop_tanah">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="njop_bangunan">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="ssp_tanggal">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label>SSP Nilai</label>
                        <input type="text" class="form-control" name="ssp_nilai">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label>Tanggal SSPD</label>
                        <input type="date" class="form-control" name="sspd_tanggal">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label>SSPD Nilai</label>
                        <input type="text" class="form-control" name="sspd_nilai">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label>Tanggal SSB</label>
                        <input type="date" class="form-control" name="ssb_tanggal">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label>SSB Nilai</label>
                        <input type="text" class="form-control" name="ssb_nilai">
                    </div>
                </div>
            </div>
