            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <select class="form-select form-select-lg" name="selaku" id="selaku">
                            <option disabled selected value>--- Pilih Selaku ---</option>
                            <option value="Penjual" {{($pihak->selaku == 'Penjual') ? 'selected':''}}>Penjual</option>
                            <option value="Pembeli" {{($pihak->selaku == 'Pembeli') ? 'selected':''}}>Pembeli</option>
                            <option value="Pemberi Kuasa" {{($pihak->selaku == 'Pemberi Kuasa') ? 'selected':''}}>Pemberi Kuasa</option>
                            <option value="Penerima Kuasa" {{($pihak->selaku == 'Penerima Kuasa') ? 'selected':''}}>Penerima Kuasa</option>
                            <option value="Persetujuan" {{($pihak->selaku == 'Persetujuan') ? 'selected':''}}>Persetujuan</option>
                            <option value="Pemberi Hibah" {{($pihak->selaku == 'Pemberi Hibah') ? 'selected':''}}>Pemberi Hibah</option>
                            <option value="Penerima Hibah" {{($pihak->selaku == 'Penerima Hibah') ? 'selected':''}}>Penerima Hibah</option>
                            <option value="Ahli Waris" {{($pihak->selaku == 'Ahli Waris') ? 'selected':''}}>Ahli Waris</option>
                        </select>
                    </div>
                </div>
                <div class="col">
