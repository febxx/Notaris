...
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        ...
        <form action="{{ route('akta-ppat-pihak.store') }}?id={{$data->id}}" method="post">
            @csrf
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select class="form-select form-select-lg" name="selaku" id="selaku">
                            ...
                            <option value="Pemberi Kuasa">Pemberi Kuasa</option>
                            <option value="Penerima Kuasa">Penerima Kuasa</option>
                            <option value="Persetujuan">Persetujuan</option>
                            <option value="Pemberi Hibah">Pemberi Hibah</option>
            ...
            <div class="form-group">
                <label for="alamat_sementara">Alamat Sementara</label>
                <input type="text" class="form-control" id="alamat_sementara" name="alamat_sementara">
            </div>
