...
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        ...
        @endif
        <form action="{{ route('akta-ppat-jenis.store') }}" method="post">
            @csrf
            ...
            <div class="form-group">
                <label for="jenis">Akta PPAT Jenis</label>
                <input type="text" class="form-control" id="jenis" name="deskripsi" required>
            </div>
            <div class="card my-4">
