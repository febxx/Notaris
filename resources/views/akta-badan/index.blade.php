...
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        ...
        @endif
        <a href="{{ route('akta-badan.create') }}" class="btn btn-dark">Tambah Akta</a>
        <table class="table table-bordered" id="akta-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('akta-badan.show', $item->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        <a href="{{route('akta-badan.edit', $item->id)}}" class="btn btn-info"><i class="fa fa-pen"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
