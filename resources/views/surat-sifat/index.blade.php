...
<main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg">
    ...
    <div class="container-fluid py-4">
        ...
        @endif
        <a href="{{ route('surat-sifat.create') }}" class="btn btn-dark">Tambah Sifat Surat</a>
        <table class="table table-bordered" id="akta-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->name }}</td>
                    <td>
                        <a href="{{route('surat-sifat.show', $item->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        <a href="{{route('surat-sifat.edit', $item->id)}}" class="btn btn-info"><i class="fa fa-pen"></i></a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{route('surat-sifat.destroy', $item->id)}}" method="post">
