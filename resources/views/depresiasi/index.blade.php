        ...
        <table class="table table-bordered" id="akta-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->nominal }}</td>
                    <td>
                        <a href="{{route('depresiasi.show', $item->id)}}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                        <a href="{{route('depresiasi.edit', $item->id)}}" class="btn btn-info"><i class="fa fa-pen"></i></a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{route('depresiasi.destroy', $item->id)}}" method="post">
